...
> **현재 작업 (2026-09-21):** `codex/rebirth-2026-09`에서 Life Quest: 경계의 서가 공개 프리뷰 준비 중. 아래 4월 이력의 완료를 현재 출시 상태로 해석하지 않는다.
...
> 무료3권·선택 AI·백업·카드 탐험. 조수 우체국은2장면 체험, 판매off. 가격·수익은 미검증. 이번 공개판은2.0.0+7 예정, 실제 빌드/공개 완료는 최신 체크포인트의 해시·링크로 확인.
