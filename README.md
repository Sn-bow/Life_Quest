...
현실의 작은 행동을 경험치와 이야기로 바꾸는 Android 습관 RPG. 현대 판타지의 상태창에서 영감을 받은 인터페이스, 기기 안에서 만드는 개인화 퀘스트, 짧은 카드 던전을 연결합니다.

![Life Quest 생성 이미지 배너](docs/rebirth/store/feature-graphic-1024x500.png)

**2.0 재구축 중 · 2026-09-17.** Google Play 공개 출시와 유료 판매는 아직 시작하지 않았습니다. Cloud·결제·광고는 기본적으로 꺼져 있습니다. 실제 출시에 남은 일과 작업 재개 정보는 [CONTINUE.md](docs/rebirth/CONTINUE.md)를 기준으로 확인하세요.
...
- **무료 이야기 「0번 출구」:** 일상 퀘스트를 완료하면 네 장면이 열리고 선택이 후속 대사에 반영됩니다. 읽기만으로 XP를 주지 않습니다.
...
기본 퀘스트·AI·백업은 무료로 유지하고, 완결형 스토리 챕터와 상태창 테마를 한 번 구매해 소장하는 방식을 검증하려 합니다. 실제 상품이 완성되고 테스트 구매·환불·복원이 확인되기 전에는 판매하지 않습니다. 가격·전환율·수익은 아직 검증되지 않았습니다.
...
- Flutter analyze: 문제 없음. 전체283개 테스트 통과.
...
[제품 방향](docs/rebirth/PRODUCT_BRIEF.md) · [모델 선정·실측](docs/rebirth/ON_DEVICE_AI_DECISION.md) · [던전 저장](docs/rebirth/DUNGEON_CHECKPOINTS.md) · [암호화 백업](docs/rebirth/DEVICE_BACKUP.md) · [구매 계정](docs/rebirth/PURCHASE_ACCOUNT.md) · [신고 운영](docs/rebirth/AI_REPORTING.md) · [결제·출시](docs/rebirth/BILLING_AND_RELEASE.md) · [Play 초안·테스트](docs/rebirth/store/STORE_AND_TEST_PLAN.md)
