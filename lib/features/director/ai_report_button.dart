...
class AiReportButton extends StatelessWidget {
  ...
  const AiReportButton(
      {super.key, required this.content, required this.onReported});
  @override
  Widget build(BuildContext context) {
    ...
    return TextButton.icon(
        ...
        onPressed: () async {
          final result = await showDialog<AiReportResult>(
              context: context,
          ...
          messenger.showSnackBar(SnackBar(
            ...
            AiReportResult.queued => s.lqReportQueued,
            ...
            TextButton(
                onPressed: sending
                    ...
                    : () async {
                        ...
                        final result = await const AiReportService()
                            .submit(widget.content);
                        if (!context.mounted) return;
