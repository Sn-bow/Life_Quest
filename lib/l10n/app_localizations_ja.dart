...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String questsRewardSummary(int xp, int gold, int ap) {
    return '合計報酬: $xp XP · $gold ゴールド · AP +$ap';
  }

  @override
  String questsRewardStatPoints(int sp) {
    return '追加ステータスポイント +$sp';
  }
  ...
  @override
  String get defaultReward1Name => '美味しいおやつを食べる';

  @override
  String get defaultReward1Desc => 'お気に入りのおやつを1つ楽しむ';

  @override
  String get defaultReward2Name => '30分ゲームをする';

  @override
  String get defaultReward2Desc => '罪悪感なしで30分プレイする';

  @override
  String get defaultReward3Name => '動画・映画を観る';

  @override
  String get defaultReward3Desc => 'YouTubeやNetflixを1時間見る';
  ...
  @override
  String get shopAdSupportTitle => '選択型報酬広告は無効です';

  @override
  String get shopAdSupportDesc => '現在の標準Androidリリースでは広告報酬を提供していません。';

  @override
  String get shopAdModelTitle => '収益化機能は準備中です';

  @override
  String get shopAdModelDesc =>
      '現在の標準Androidリリースでは広告とアプリ内課金は無効です。今後のプレミアム機能は明確に案内してから提供します。';
  ...
  @override
  String get settingsAdSupportSection => '収益化のご案内';

  @override
  String get settingsAdSupportTitle => '広告と課金は無効です';

  @override
  String get settingsAdSupportDesc => '現在の標準Androidリリースでは広告報酬とアプリ内課金を提供していません。';

  @override
  String get settingsAdModelTitle => 'プレミアム機能は準備中です';

  @override
  String get settingsAdModelDesc => '今後有料機能を提供する場合は、価格、特典、解約方法を明確に案内します。';
  ...
  String get cosmeticComingSoonDesc =>
      '現在の標準Androidリリースではコスメティック購入を提供していません。テーマとエフェクト機能は後日案内してから公開します。';
  ...
  @override
  String get cosmeticComingSoonSnackbar => 'コスメティック商品は後日案内してから公開します。';
  ...
  String dungeonRestCardUpgradeResult(String name) {
    return '「$name」カードが強化されました！';
  }

  @override
  String get dungeonEventCardRewardTitle => 'カードを選んでください';
  ...
  @override
  String get cardBattleDrawPile => 'ドロー';

  @override
  String get cardBattleDiscardPile => '捨て札';

  @override
  String get cardBattleIntentAttack => '攻撃';

  @override
  String get cardBattleIntentMultiAttack => '連続攻撃';
