...
class GrowthHubScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(title: Text(s.lqGrowth), actions: [
          IconButton(
        ...
        body: ListView(
            ...
            children: [
              ...
              HunterStatusSummary(state: state),
              const SizedBox(height: 18),
              LayoutBuilder(builder: (context, box) {
                final columns = box.maxWidth < 340 ||
              ...
              Card(
                  child: ListTile(
                      ...
                      leading: Icon(PhosphorIcons.cpu,
                          color: theme.colorScheme.secondary),
                      title: Text(s.lqDirector),
                      subtitle:
                          Text(s.lqModelName, style: theme.textTheme.bodySmall),
                      trailing: const Icon(PhosphorIcons.caretRight, size: 17),
