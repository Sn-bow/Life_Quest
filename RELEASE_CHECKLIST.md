...
| 릴리스 빌드 | ✅ 2026-06-05 기본 release AAB 빌드 성공: 159,415,691 bytes / 152.0MB (v1.0.1+2) |
...
| 항목 | 내용 |
|------|------|
| **현재 상태** | release build에 `isMinifyEnabled = true`, `isShrinkResources = true` 적용 완료. 2026-06-05 기본 release AAB 빌드 성공. `docs/lifequest-release-artifact-record-20260605.md`에 산출물과 최종 Manifest 검증 기록을 남겼고 readiness가 AAB 존재/최소 크기 및 광고·결제 권한과 Mobile Ads 구성요소 부재를 확인한다. |
