...
> **최신 홍보 수정:** 해외에서 먼저 유입을 만든다. 대만 번체 중심 첫2주, 영어/번체 프로필, TW-01 첫 게시물. 한국어2개+번체2개 일정은 폐기. `PLAY_GLOBAL_LAUNCH.md`와 `marketing/THREADS_STARTER_KIT.md`를 수정했다. 앱 번체 지원과 Play 배포는 여전히 미완료이며 SNS 게시/광고 구매 없음.
