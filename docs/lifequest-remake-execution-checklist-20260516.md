...
- [ ] Firebase Hosting 배포
- [ ] 공개 URL smoke QA
- [x] localStorage 신규 사용자 상태 확인 (`lifequest-qa-preview-localstorage-audit-20260520.md`)
- [x] 광고/결제/민감 기능 숨김 확인
...
- [x] QA Preview localStorage 데이터 범위 확인 (`lifequest-qa-preview-localstorage-audit-20260520.md`)
- [x] 개인정보처리방침 최신화
...
- [x] Android release readiness script blocks purchase verification local-fallback regressions (`scripts/check_release_readiness.sh`)
